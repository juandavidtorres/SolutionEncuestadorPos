    ...
    public class Tokheim : iProtocolo
    {
        ...
        public Tokheim(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
               ...
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.05.06 0019"); //06/05/2017 Reducion de tiempo erro en eds Peru Marco se detien los despachos por falta de encuesta. 
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.06.15 1243");//DCF 15/06/2017 
       ...
       // #endregion
        ...
        public void VerifySizeFile()
        {
            try
            {
                ...
                {
                    SWTramas.Close();
                    ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMddhh") + "-Tokheim-Tramas.(" + PuertoCom.PortName + ").txt";
                    SWTramas = File.AppendText(ArchivoTramas);
                }
                ...
                if (FileInf.Length > 30000000)
                {
                    SWRegistro.Close();
                    //Crea archivo para almacenar inconsistencias en el proceso logico
                    Archivo = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMddhh") + "-Tokheim-Sucesos(" + PuertoCom.PortName + ").txt";
                    SWRegistro = File.AppendText(Archivo);
                }
            }
            catch (Exception ex)
