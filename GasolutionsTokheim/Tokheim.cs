    ...
    public class Tokheim : iProtocolo
    {
        ...
        public Tokheim(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.08.18 2245 *");//DCF 18/08/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.09.25 1513 *");//DCF 25/09/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.01.10 2253 *");//DCF 19/01/2018 2250  
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.03.08 1846 *");//DCF Archivos .txt 08/03/2018  
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.03.20 1503 *");//DCF 20/03/2018 Logueo Tramas
                SWRegistro.Flush();
                ...
                foreach (RedSurtidor oCara in EstructuraRedSurtidor.Values)
                {
                    ...
                    foreach (Grados oGrado in EstructuraRedSurtidor[oCara.Cara].ListaGrados)
                    {
                        ...
                        SWRegistro.WriteLine(DateTime.Now + "|" + oCara.Cara + "|Inicio|Grado: " + oGrado.NoGrado + " - Manguera: " + oGrado.MangueraBD +
                            " - IdProducto: a" + oGrado.IdProducto + " - Precio: " + oGrado.PrecioNivel1 + " - Venta Parcial: " + oCara.EsVentaParcial + " -GradoMangueraVentaParcial: " + oCara.GradoMangueraVentaParcial + " -LogueoTramas = " + LogueoTramas);
                    }
        ...
        public Tokheim(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.08.18 2245 /");//DCF 18/08/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.09.25 1513 ");//DCF 25/09/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.01.20 1153 ");//DCF 19/01/2018 2250  
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.03.20 1503");//DCF 20/03/2018 Logueo Tramas
                SWRegistro.Flush();
                        ...
                        foreach (Grados oGrado in EstructuraRedSurtidor[oCara.Cara].ListaGrados)
                        {
                            if (EstructuraRedSurtidor[oCara.Cara].EsVentaParcial)//DCF 25/09/2017
                            {
                                if (Convert.ToInt32(EstructuraRedSurtidor[oCara.Cara].GradoMangueraVentaParcial) >= 0)
                                {
                                    ...
                                    SWRegistro.WriteLine(DateTime.Now + "|" + oCara.Cara + "|Inicio *** |EsVentaParcial: " + oCara.EsVentaParcial + " - GradoMangueraVentaParcial: " + oCara.GradoMangueraVentaParcial + " - GradoAutorizado: " + EstructuraRedSurtidor[oCara.Cara].GradoAutorizado + " -LogueoTramas = " + LogueoTramas);
                                }
                            }
                ...
                switch (ComandoCaras)
                {
                    ...
                    case ComandoSurtidor.Inicializar://ok
                        ...
                        if (EstructuraRedSurtidor[CaraEncuestada].Gilbarco_Extended)
                        {
                            ...
                            SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada + "|Proceso| Precio Nivel 1 para Tokheim 5 Digitos - " + EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1);
                            SWRegistro.Flush();
                            ...
                            strPrecio = Convert.ToString(Convert.ToInt32(EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1 * EstructuraRedSurtidor[CaraEncuestada].FactorPrecio)).PadLeft(6, '0');
                        ...
                        else
                        {
                            ...
                            SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada + "|Proceso| Precio Nivel 1 " + EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1);
                            SWRegistro.Flush();
                            ...
                            //            EstructuraRedSurtidor[CaraEncuestada].FactorPrecio)).PadLeft(4, '0'); //FALLA  GradoAutorizado REVISAR  //DCF 18/08/2017
                    ...
                    case ComandoSurtidor.EstablecerPrecio_CX:
                        ...
                        else
                        {
                           ...
                           SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada + "|**** cambio de precio modificado precio:  " +
       ...
       //  public void Evento_VentaAutorizada(byte Cara, string Precio, string ValorProgramado, byte TipoProgramacion, string Placa, int MangueraProgramada, bool EsVentaGerenciada, string Guid)      
        {
            ...
            try
            {
                ...
                if (EstructuraRedSurtidor.ContainsKey(CaraTmp))
                {
                    ...
                    //Loguea evento                
                    SWRegistro.WriteLine(DateTime.Now + "|" + CaraTmp + "|Evento|Recibe Autorizacion. Valor Programado " + ValorProgramado +
                                            " - Tipo de Programacion: " + TipoProgramacion + " - Manguera: " + MangueraProgramada + " - Gerenciada: " + EsVentaGerenciada + " - Precio Despacho: " + Precio);
                    SWRegistro.Flush();
