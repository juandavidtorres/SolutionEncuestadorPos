...
namespace POSstation.Protocolos
{
    ...
    public class Petromecanica_convert:iProtocolo
    {
        ...
        public Petromecanica_convert(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                this.Puerto = Puerto;
                ...
                ArchivoRegistroSucesos = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + " Petromecanica-RegistroSucesos (" + Puerto + ").txt";
                ...
                ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Petromecanica-Tramas(" + Puerto + ").txt";
                ...
                //SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS2_Converdor_DCF.  Modificado 13-01-2016 - 0242");// Ajustado para trabajar con conversor baudrate 9600 / 5787 dcf
               // SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS2_Conversor_DCF.  Modificado 20-01-2016 - 1656");//Para manejar la cara 16 Fecha: 20/01/2016 DCF  cara 16 
                //SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS2_Conversor_DCF.  Modificado 08-04-2016 - 2130");//DCF para guid 08/04/2016 2125 peru
                SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS2_Conversor_DCF.  Modificado 08-03-2018 - 1813");//DCF Archivos .txt 08/03/2018  
                ...
                if (!PuertoCom.IsOpen)
                {
                    ...
                    PuertoCom.BaudRate = 9600; //5787; //5760;OK -- Ajustado para trabajar con conversor baudrate 9600 / 5787 dcf
                ...
                switch (EstructuraRedSurtidor[CaraEncuestada].Estado)
                {
                    ...
                    case (EstadoCara.PorAutorizar):
                            ...
                            EstructuraRedSurtidor[CaraEncuestada].EsVentaParcial == false)
                        {
                            ...
                            {
                                AutorizacionRequerida(CaraID, IdProducto, IdManguera, Lectura, "");//DCF para guid 08/04/2016 2125 peru 
                            }
                        }
                ...
                while (CondicionCiclo)
                {
                    ...
                    foreach (RedSurtidor ORedCaras in EstructuraRedSurtidor.Values)
                    {
                        ...
                        if (ORedCaras.Activa == true)
                        {
                            ...
                            //Para manejar la cara 16 Fecha: 20/01/2016 DCF  cara 16 
        ...
        public void Evento_VentaAutorizada(byte Cara, string Precio, string ValorProgramado, byte TipoProgramacion, string Placa, int MangueraProgramada, bool EsVentaGerenciada, string guid, Decimal PresionLLenado)//DCF para guid 08/04/2016 2125 peru
