...
{
    public class GilbarcoKraus_2: iProtocolo
    {
        ...
        public GilbarcoKraus_2(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                SWRegistro.WriteLine("=====================================================================");
                //SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS.  Modificado 17-06-2013 - 1634"); //BytesEsperados1 = 124; Kraus Chimbote Peru 17-06-2013 DCF                                        
                //SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS.  Modificado 21-06-2013 - 1239"); //Baud rade 5787  se cambio por 5760 -- no fuciona                                  
                SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS 2.  Modificado 13-08-2015 - 1725"); //TiemOut    
                SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS 2.  Modificado 08-03-2018 - 1655"); //DCF Archivos .txt 08/03/2018               
                ...
                if ((ComandoTx != ComandoSurtidor.Estado) && (ComandoTx != ComandoSurtidor.EnviarDatos))
                {
                    switch (ComandoTx)
                    {
                        ...
                        case (ComandoSurtidor.Totales):             //Pide Totalizadores
                            ...
                            //SWTramas.WriteLine(DateTime.Now + " Rx.Cara " + CaraID + "Totales - NUmero de BytesEsperados1 = " + BytesEsperados1); //DCF Borrar
                            // SWTramas.Flush();
                            break;
        ...
        //            SWTramas.Close();
        //            ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-GilbarcoKraus-Tramas(" + PuertoCom.PortName + ").txt";
        //            SWTramas = File.AppendText(ArchivoTramas);
        //        }
        ...
        //            SWRegistro.Close();
        //            //Crea archivo para almacenar inconsistencias en el proceso logico
        //            ArchivoRegistroSucesos = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-GilbarcoKraus-RegistroSucesos(" + PuertoCom.PortName + ").txt";
        //            SWRegistro = File.AppendText(ArchivoRegistroSucesos);
        //        }
        //    }
        ...
        public void RecibirInformacion()
        {
            try
            {
                ...
                //SWTramas.WriteLine(DateTime.Now + " Rx.Cara " + CaraID + " NUmero de Bytes = " + Bytes); //DCF Borrar
                //SWTramas.Flush();
        ...
        public void RecuperarDatosFindeVenta()
        {
            try
            {
                ...
                if (LRCObtenidoEnTama == LRCCalculado)//Eco
                {
                    ...
                    //if (CaraqueResponde == CaraEncuestada) --- no responde el grado que despacho 17-06-2013
                    //{
        ...
        public void RecuperarTotalizadores()
        {
            try
            {
                //SWRegistro.WriteLine(DateTime.Now + "|Cara|" + CaraID + "|(" + ComandoCaras + ") Recuperar Totalizadores ---"); //DCF Borrar 
                //SWRegistro.Flush();
                ...
                else
                {
                    ...
                    SWRegistro.WriteLine(DateTime.Now + "|Cara|" + CaraID + "|(" + ComandoCaras + ") LRCCalculado = " + LRCCalculado + " / LRCObtenidoEnTrama =" + LRCObtenidoEnTrama);
        ...
        public void Evento_ProgramarCambioPrecioKardex(ColMangueras mangueras)//Realizado por el remplazo del shared event, usa una interfaz en el 
        { }
