...
{
    public class Gilbarco_2A : POSstation.Protocolos.iProtocolo

    {
        ...
        public Gilbarco_2A(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                if (!PuertoCom.IsOpen)
                {
                    ...
                    PuertoCom.BaudRate = 9600;//oRIGINAL --5760
                ...
                //ArchivoTramas = DateTime.Today.ToString("yyyymmdd") + "-Gilbarco_2A-Tramas.(" + Puerto + ").txt";
                ...
                Archivo = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Gilbarco_2A-Sucesos(" + Puerto + ").txt";
                SWRegistro = File.AppendText(Archivo);

                ////Crea archivo para almacenar las tramas de transmisión y recepción (Comunicación con Surtidor)
                ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Gilbarco_2A-Tramas.(" + Puerto + ").txt";
                SWTramas = File.AppendText(ArchivoTramas);
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2009.11.05-1851");
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2010.10.27-1855"); // Precio de venta Multiplicar por factor. 9999--->10000
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2010.12.19-1037"); // TimeOut
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.03.15-1705"); // MultiplicadorPrecioVenta =10 Precio/10 solo para terpel DCF
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.05.14-1045");//Alias para manejAR MAS DE 16 CaraTmp = ConvertirCaraBD(Cara);
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.06.04-1000");//LOgueo para mirara error en cambio precio borra
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.08.02-1750"); //Porcentaje del 5% //DCF 02-08-2011 corrección para Perú 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.18.11-1631"); // CaraID = EstructuraRedSurtidor[CaraEncuestada].CaraBD; //DCF Alias
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.29.11-1549"); // CaraID = EstructuraRedSurtidor[CaraEncuestada].CaraBD; //DCF Alias
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2011.24.03-1227"); // Cambio de precio / MultiplicadorPrecioVenta para el cambio de producto 24-03-2012
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.09-0934"); // ThreadPool.QueueUserWorkItem(CicloCara); -- Log 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.17-1200"); // ThreadPool.QueueUserWorkItem(CicloCara); -- Log --- // Thread HiloVenta  13/04/2012
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.17-1522"); // se comentario el cambio de precioKardes
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.18-1430"); // HiloAutorizacion.Start(DatosAutorizacion);
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.21-0858"); // HiloAutorizacion.Start(DatosAutorizacion);//21/04/2012 DCF hilo para el envio de datos en Venta parciales 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.04.27-1545"); //if (EstructuraRedSurtidor[CaraTmp].MultiplicadorPrecioVenta == 0) --- = 1
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.05.08-0916"); //sin Log SWTramas2
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.05.09-1738"); //if (EstructuraRedSurtidor[CaraTmp].MultiplicadorPrecioVenta == 0)-- 09/05/2012
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.06.23-1117"); //Convert.ToInt32(vPreciosGrado[0]) --- .ToByte
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.09.05-1026");  //DCF 05/09/2012-- Log en Excepcion  oEventos.InformarVentaParcial  y correcion en Excepcion precio =0 AL reiniciar el sistema con venta en curso ; 
                 //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.11.16-1632");  //PuertoCom Close
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.11.21-1545"); //|Excepcion|VerifySizeFile
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2013.04.10-1600");//EstructuraRedSurtidor[CaraEncuestada].TotalVenta = TotalVentaCalculada; //DCF ___ prioridad al valor entregado por el surtidor 10/04/2013
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2013.05.06-1712");//para la cara 16 se envio 0 DCF 06/05/2013
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2013.10.23-1551");//Baud 9600 para surtidor 2A protocolo Gilbarco
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2015.01.23 0847");//LI de la proxima vengta sera igual a la Lf de la venta terminada -- 21-11-2013
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2015.08.13 505");//LI de la proxima vengta sera igual a la Lf de la venta terminada -- 21-11-2013
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2018.03.08 1643"); //DCF Archivos .txt 08/03/2018  
        ...
        public Gilbarco_2A(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            ...
            try
            {
                ...
                if (EsTCPIP)
                {
                    try
                    {
                        ...
                        ClienteGilbarco_2A = new TcpClient(DireccionIP, Convert.ToInt16(Puerto));
                        Stream = ClienteGilbarco_2A.GetStream();
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2015.01.23 0847");//LI de la proxima vengta sera igual a la Lf de la venta terminada -- 21-11-2013
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A. Modificado 2015.08.13 505");//LI de la proxima vengta sera igual a la Lf de la venta terminada -- 21-11-2013
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_2A_TCP/IP. Modificado 2017.05.08 1955");//TCP_IP
                    ...
                    try
                    {
                        ...
                        foreach (RedSurtidor ORedCaras in EstructuraRedSurtidor.Values)
                        {
                            ...
                            if (ORedCaras.Activa == true)
                            {
                                ...
                                if (CaraEncuestada == 16)//para la cara 16 se envio 0 DCF 06/05/2013
                                {
                                    CaraEncuestada = 0;
                                }
...
"|" + CaraID + "|*8|Verificando conexion 2 " + EsInicializado);
                ...
                if (!this.ClienteGilbarco_2A.Client.Connected)
                {
                    ...
                    try
                    {
                        ClienteGilbarco_2A.Client.BeginDisconnect(true, callBack, ClienteGilbarco_2A);
                ...
                while (!this.ClienteGilbarco_2A.Client.Connected)
                {
                    try
                    {
                        ...
                        ClienteGilbarco_2A.Client.BeginConnect(Dns.GetHostAddresses(this.DireccionIP), Convert.ToInt16(this.Puerto), callBack, ClienteGilbarco_2A);
                        //ClienteGilbarco_2A.Client.Connect(Dns.GetHostAddresses(this.DireccionIP), Convert.ToInt16(this.Puerto));
                ...
                this.Stream = ClienteGilbarco_2A.GetStream();
                if (!estadoAnterior)
                {
        ...
        void AbrirSocketReintento()
        {
            try
            {
                ...
                ClienteGilbarco_2A = new TcpClient(DireccionIP, Convert.ToInt16(Puerto));
                Stream = ClienteGilbarco_2A.GetStream();
                if (this.ClienteGilbarco_2A.Client.Connected == true)
                {
        ...
        public void LimpiarSockets()
        {
            try
            {
                //ClienteGilbarco_2A.Client.Disconnect(false);  
                ClienteGilbarco_2A.Client.Close();
                ClienteGilbarco_2A.Close();
                Stream.Close();
                Stream.Dispose();
                Stream = null;
                ClienteGilbarco_2A = null;
            }
            catch (Exception ex)
            {
        ...
        public void EnviarComando()
        {
            try
            {
                ...
                {                    
                    ...
                    //Thread.Sleep(TimeOut +250); //Para Prueba OJO DCF Borrar
                ...
                switch (EstructuraRedSurtidor[CaraEncuestada].Estado)
                {
                    ...
                    case (EstadoCara.Despacho):
                        ...
                        if (ErrorComunicacion == false)
                        {
                            ...
                            //oEventos.InformarVentaParcial( CaraID,  strTotalVenta,  strVolumen);
                    ...
                    case (EstadoCara.PorAutorizar):
                            ...
                            EstructuraRedSurtidor[CaraEncuestada].EsVentaParcial == false)
                        {
                            ...
                            //    {
                                        ...
                                        EstructuraRedSurtidor[CaraEncuestada].GradoAutorizado)
                                    {
                                       ...
                                       // oEventos.RequerirAutorizacion( CaraID,  IdProducto,  IdManguera,  Lectura);
                        ...
                        else if (EstructuraRedSurtidor[CaraEncuestada].AutorizarCara == true)
                        {
                            ...
                            //    SWRegistro.Flush();
                            //    EstructuraRedSurtidor[CaraEncuestada].AutorizarCara = false;
                            //    oEventos.InformarCambioMangueraEnVentaGerenciada( CaraID);
                            //}
                            //else
                            //{
        ...
        public void InfoVentaParcial(object datos) //21/04/2012 DCF hilo para el envio de datos en Venta parciales 
        {
            ...
            catch (Exception Excepcion)
            {
                ...
                SWRegistro.Flush(); // DCF 05/09/2012 oEventos.InformarVentaParcial 
                    ...
                    if (EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count - 1 >= EstructuraRedSurtidor[CaraEncuestada].GradoVenta)
                    {
                        ...
                        if (VolumenCalculado >= 0)
                        {
                            ...
                            if (EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoVenta].LecturaInicialVenta > 0)
                            {
                                if (EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoVenta].LecturaFinalVenta > 0)
                                {
                                    ...
                                    {
                                        SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|Inconsistencia|Volumen Calculado: " + VolumenCalculado +
                        ...
                        if (EstructuraRedSurtidor[CaraEncuestada].Volumen != 0)
                        {
                                ...
                                EstructuraRedSurtidor[CaraEncuestada].TotalVenta < TotalVentaCalculada - (PorcentajeVenta)) // Para Peru 
                            {
                                ...
                                SWRegistro.Flush();
                                //EstructuraRedSurtidor[CaraEncuestada].TotalVenta = TotalVentaCalculada; //DCF ___ prioridad al valor entregado por el surtidor 10/04/2013
                            ...
                            //oEventos.InformarFinalizacionVenta( CaraEncuestada,  strTotalVenta,  strPrecio,  strLecturaFinalVenta,
                            // strVolumen,  bytProducto,  IdManguera,  PresionLLenado,  strLecturaInicialVenta);


                            //Actualizar la Lectura inicial en caso de que no se reporte en la proxima venta la lectura inicial o 
                            //inicie despacho sin la aoutorizacion ---> |Estado|Despacho - 90 -- 21-11-2013
                            //LI de la proxima vengta sera igual a la Lf de la venta terminada -- 21-11-2013
                            EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoVenta].LecturaInicialVenta =
                            EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoVenta].LecturaFinalVenta;

                            EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoVenta].LecturaFinalVenta = 0;

                            //se borra la lectura Final
        ...
        public void InformarFinalizacionVenta(object args)
        {
            ...
            VentaFinalizada(CaraEncuestadaFinVenta, strTotalVenta, strPrecio, strLecturaFinalVenta,
             strVolumen,  bytProducto,  IdManguera,  PresionLLenado,  strLecturaInicialVenta);
        ...
        public void RecuperarDatosFindeVenta()
        {
            try
            {
                ...
                if (LRCObtenidoEnTama == LRCCalculado)//Eco
                {
                    ...
                    if (CaraqueResponde == 16)//para la cara 16 se envio 0 DCF 06/05/2013
                    {
                        CaraqueResponde = 0;
                    }
        ...
        public void RecuperarParcialesdeVenta()
        {
            try
            {
                ...
                else
                {
                    EstructuraRedSurtidor[CaraEncuestada].Volumen =
                       EstructuraRedSurtidor[CaraEncuestada].TotalVenta /
                        (EstructuraRedSurtidor[CaraEncuestada].ListaGrados[EstructuraRedSurtidor[CaraEncuestada].GradoAutorizado].PrecioNivel1 * EstructuraRedSurtidor[CaraEncuestada].MultiplicadorPrecioVenta);//DCF 05/09/2012
                }
                //;
        ...
        //public void PollingTimerEvent(object source, ElapsedEventArgs e)
        //{
        //    try
        //    {
        ...
        public void Evento_InactivarCaraCambioTarjeta( byte Cara,  string Puerto)
        {
            ...
            {
                string MensajeExcepcion = "Excepcion en el Evento Evento_InactivarCaraCambioTarjeta: " + Excepcion;
        ...
        {            
            try
            {
                ...
                //// -- Modificado 2012.04.09-0934
                //SWRegistro.WriteLine(DateTime.Now + "|" + Cara + "|  Recibe oEvento_VentaAutorizada..."); //(1)
                //SWRegistro.Flush();
        ...
        //public void RecepcionVentaAutorizada( byte Cara,  string Precio,  string ValorProgramado,  byte TipoProgramacion,  string Placa,  int MangueraProgramada,  bool EsVentaGerenciada) // Thread HiloVenta  13/04/2012
        //{    
        //    try
        //    {
