...
{
    public class Gilbarco: POSstation.Protocolos.iProtocolo
    {
        //Declaracion de eventos que lanza el protocolo
        ...
        public Gilbarco(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //TODO:Revisar evento oEventos.FinalizarVentaPorMonitoreoCHIP +=new SharedEventsFuelStation.__CMensaje_FinalizarVentaPorMonitoreoCHIPEventHandler(oEventos_FinalizarVentaPorMonitoreoCHIP);
                ...
                if (!PuertoCom.IsOpen)
                {
                    ...
                    PuertoCom.BaudRate = 5787;//5760;//oRIGINAL
                ...
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2014.09.18-1222-*"); //cambio de baudrate a 5787
                ...
                switch (EstructuraRedSurtidor[CaraEncuestada].Estado)
                {
                    ...
                    case (EstadoCara.Despacho):
                        ...
                        if (ErrorComunicacion == false)
                        {
                            ...
                            //oEventos.InformarVentaParcial(ref CaraID, ref strTotalVenta, ref strVolumen);
                            ...
                            do
                            {
                                if (RecuperarEstadoExtendido())
                                {
                                        ...
                                        EstructuraRedSurtidor[CaraEncuestada].GradoAutorizado)
                                    {
                                       ...
                                       // oEventos.RequerirAutorizacion(ref CaraID, ref IdProducto, ref IdManguera, ref Lectura);
        ...
        private void InformarFinalizacionVentaAux(object args)
        {
            ...
            byte bytProducto = Convert.ToByte(Argumentos[5]);
        ...
        public void VerifySizeFile()
        {
            try
            {
                ...
                {
                    SWTramas.Close();
                    ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Gilbarco-Tramas.(" + PuertoCom.PortName + ").txt";
                    SWTramas = File.AppendText(ArchivoTramas);
                }
                ...
                if (FileInf.Length > 30000000)
                {
                    SWRegistro.Close();
                    //Crea archivo para almacenar inconsistencias en el proceso logico
                    Archivo = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Gilbarco-Sucesos(" + PuertoCom.PortName + ").txt";
                    SWRegistro = File.AppendText(Archivo);
                }
        ...
        //EGV: EVENTO PARA SOLICITAR INACTIVACION DE CARA
         public void Eventos_InactivarCaraCambioTarjeta(byte Cara, string Puerto)
        {
            try
            {
            ...
            {
                string MensajeExcepcion = "Excepcion en el Evento oEventos_InactivarCaraCambioTarjeta: " + Excepcion;
        ...
        public void Eventos_FinalizarCambioTarjeta(byte Cara)
        {
            try
            {
                //CaraID = EstructuraRedSurtidor[Cara].CaraBD; //DCF Alias
            ...
            {
                string MensajeExcepcion = "Excepcion en el Evento oEventos_FinalizarCambioTarjeta: " + Excepcion;
                SWRegistro.WriteLine(DateTime.Now + "|" + Cara + "|Excepcion|" + MensajeExcepcion);
                SWRegistro.Flush();
            }
        }

        public void Eventos_VentaAutorizada(byte Cara, string Precio, string ValorProgramado, byte TipoProgramacion, string Placa, int MangueraProgramada, bool EsVentaGerenciada)
        {            
            try
            {
        ...
        public void Eventos_TurnoAbierto( string Surtidores, string PuertoTerminal, System.Array Precios)
        {
            try
            {
                //Loguea evento
        ...
        public void Eventos_TurnoCerrado(string Surtidores, string PuertoTerminal)
        {
            try
            {
                //Loguea evento
        ...
        public void Eventos_ProgramarCambioPrecioKardex(ColMangueras  mangueras)
        { 
            try
            {
        ...
        public void Eventos_FinalizarVentaPorMonitoreoCHIP(byte Cara)
        {
            try
            {
        ...
        public void Eventos_CerrarProtocolo()
        {
