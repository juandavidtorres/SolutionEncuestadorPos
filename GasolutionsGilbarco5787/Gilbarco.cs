    ...
    public class Gilbarco: iProtocolo
    {
        ...
        public Gilbarco(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2012.05.09-173-*"); //if (EstructuraRedSurtidor[CaraTmp].MultiplicadorPrecioVenta == 0)-- 09/05/2012
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2014.09.18-1242-*"); //cambio de baudrate a 5787
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco 5787. Modificado 2014.09.21-0300");//Proceso|Surtidor con repuesta en 00 en  EstadoExtendido:
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco 5787. Modificado 2018.03.08-1800");//DCF Archivos .txt 08/03/2018  
            ...
            try
            {
                switch (ComandoCaras)
                {
                    ...
                    case (ComandoSurtidor.EstadoExtendido):
                        ...
                        // eds SOl de Oro Peru responde todo los bytes en 0x00
                        //21/09/2014|02:51:11.903|7|Tx|FF|E9|FE|E0|E1|E0|FB|EE|F0|
                        //21/09/2014|02:51:12.103|7|Rx|00|00|00|00|00|00|00|00|00|00|00|00|00|00|00|00|00|00|00|
                        if (TramaRx[0] == 0x00 && TramaRx[18] == 0x00)// BytesEsperados = 19;
                        {
                            EstructuraRedSurtidor[CaraEncuestada].GradoAutorizado = 0;

                            SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|Proceso|Surtidor con repuesta en 00 en  EstadoExtendido: " );
                            SWRegistro.Flush();
                        }
                        break;
                }
