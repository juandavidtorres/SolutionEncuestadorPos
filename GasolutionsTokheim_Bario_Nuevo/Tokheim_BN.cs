    ...
    public class Tokheim : iProtocolo
    {
        ...
        public Tokheim(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.01.20 1426 *");//DCF 19/01/2018 2250  
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.03.08 1849 *");//DCF Archivos .txt 08/03/2018  
                SWRegistro.Flush();
        ...
        public Tokheim(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.08.18 2245 /");//DCF 18/08/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2017.09.25 1513 ");//DCF 25/09/2017
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2018.01.20 1427 ");//DCF 19/01/2018 2250  
                SWRegistro.Flush();
                ...
                switch (ComandoCaras)
                {
                    ...
                    case ComandoSurtidor.EstablecerPrecio_CX:
                        ...
                        else
                        {
                            ...
                            //                    
                            //TramaTx = new byte[8] {0XC4, 0X3B, 0XA3, 0X5C, 0X81, 0X7E, 0X97, 0X68};//DCF 19/01/2018 2250 XX -

                            TramaTx = new byte[20] { 0xD3, 0x2C, 0xA3, 0x5C, 0x86, 0x79, 0x94, 0x6B, 0x81, 0x7E, 0x97, 0x68, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF, 0x00, 0xFF };
