...
{
    public class Falcon: iProtocolo
    {
        ...
        public Falcon(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                if (!PuertoCom.IsOpen)
                {
                    ...
                    PuertoCom.BaudRate = 9600;//5760; es configurable el baudrate 
                    PuertoCom.DataBits = 8;
                    PuertoCom.StopBits = StopBits.One;
                    PuertoCom.Parity = Parity.Even; //Parity.Even;
                ...
                Archivo = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Falcon-Sucesos(" + Puerto + ").txt";
                ...
                ArchivoTramas = Application.StartupPath + "/LogueoProtocolo/" + DateTime.Now.ToString("yyyyMMdd") + "-Falcon-Tramas.(" + Puerto + ").txt";
               ...
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_Extended_TCPIP. Modificado 14.08.2015-1615");//DCF Modificacion 14/08/2015 EDS Sodis Aeropuerto  Leer siempre la respuesta del surtidor
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 25.04.2017-1728");//Protocolo Falcon
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 27.04.2017-1249"); //PuertoCom.BaudRate = 9600;//5760; es configurable el baudrate 
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 08.03.2018-1619");//DCF Archivos .txt 08/03/2018  
        ...
        public Falcon(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {                                
                if (!Directory.Exists(Application.StartupPath + "/LogueoProtocolo"))
              ...
              // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_Extended_TCPIP. Modificado 06.08.2014-1122");//TCPIP
               ...
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_Extended_TCPIP. Modificado 25.09.2014-1017");// cambio de precio para un cliente X
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_Extended_TCPIP. Modificado 21.04.2015-1734");  //Para varias Mangueras 21-04-2015
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco_Extended_TCPIP. Modificado 14.08.2015-1615");//DCF Modificacion 14/08/2015 EDS Sodis Aeropuerto  Leer siempre la respuesta del surtidor
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 25.04.2017-1727");//Protocolo Falcon
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 27.04.2017-1249"); //PuertoCom.BaudRate = 9600;//5760; es configurable el baudrate 
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Falcon. Modificado 08.03.2018-1619");//DCF Archivos .txt 08/03/2018  
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Numero de caras: " + EstructuraRedSurtidor.Count);
                SWRegistro.Flush();
            ...
            try
            {
                ...
                foreach (RedSurtidor ORedCaras2 in EstructuraRedSurtidor.Values)
                {
                    ...
                    SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada2 + "|FactorVolumen: " + Math.Log10(EstructuraRedSurtidor[CaraEncuestada2].FactorVolumen)
                           ...
                           + " - Falcon: " + EstructuraRedSurtidor[CaraEncuestada2].Gilbarco_Extended);
                ...
                while (CondicionCiclo)
                {
                    ...
                    foreach (RedSurtidor ORedCaras in EstructuraRedSurtidor.Values)
                    {
                        ...
                        if (ORedCaras.Activa == true)
                        {
                            ...
                            CaraID = EstructuraRedSurtidor[CaraEncuestada].CaraBD; 
                            //Cara consecutiva DCF Alias                                                   
        ...
        //ARMA LA TRAMA A SER ENVIADAToma lecturas iniciales para Validacion de Venta
                ...
                if ((ComandoTx != ComandoSurtidor.Estado) && (ComandoTx != ComandoSurtidor.EnviarDatos))
                {
                    switch (ComandoTx)
                    {
                        ...
                        case (ComandoSurtidor.Totales):             //Pide Totalizadores
                            ...
                            //SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|Proceso|EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count:*** " + EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count);
                            //                SWRegistro.Flush();
                                ...
                                switch (EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count) //Para varias Mangueras 21-04-2015
                                {
                                    case 1:
                                        BytesEsperados = 34; //mas 1 del bay de consulta 
                                           //SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|Proceso|EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count: 1***** ");
                                           // SWRegistro.Flush();
                                        break;
                ...
                if (PuertoCom.IsOpen)
                {
                   ...
                   //    || Bytes_leidos == 35 || Bytes_leidos == 65 || Bytes_leidos == 95 || Bytes_leidos == 125 || Bytes_leidos == 155 || Bytes_leidos == 185)//para No cambiar en el configurador los surtidores que tiene 3 manguera pero solo despachan por 1 Para varias Mangueras 21-04-2015
                    ...
                    //SWRegistro.Flush();
                        ...
                        Thread.Sleep(20);//Tiempo de prueba quitar para los pumalan Peru 
                }
                ...
                if (ProcesoEnvioComando(ComandoSurtidor.TotalDespacho, false))
                {
                    ...
                    if (EstructuraRedSurtidor[CaraEncuestada].ListaGrados.Count - 1 >= EstructuraRedSurtidor[CaraEncuestada].GradoVenta)
                    {
                        ...
                        if (EstructuraRedSurtidor[CaraEncuestada].Volumen != 0)
                        {
                            ...
                            //|1|Inconsistencia|Valor recibido en : 0,2 - Calculado: 0,2085

                            decimal PorcentajeVenta = (TotalVentaCalculada * 5) / 100;   //Porcentaje del 5% //DCF 02-08-2011 corrección para Perú 
