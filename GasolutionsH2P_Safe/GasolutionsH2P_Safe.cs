...
namespace POSstation.Protocolos
{
    ...
    public class H2P_Safe : iProtocolo  
    {
     ...
     public H2P_Safe(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 31.01.2018- 1150");//DCF19/01/2018//
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 21.02.2018- 1454");//Thread.Sleep(100);//21-02-2018 para que no bloquee el procesador en las tabletas de mexico
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 08.03.2018- 1714");//DCF Archivos .txt 08/03/2018  
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 24.08.2018- 1704");//DCF 24_08_2014
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 01.09.2018- 1934");// DCF 01/09/2018
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo H2P_Safe. Modificado 10.09.2018- 1650");//TimeOut = 400; //DCF 10/09/2018
      ...
      public H2P_Safe(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        ...
        private bool ComprobarIntegridadTrama()
        {
            try
            {
               ...
               if (ComandoCaras == ComandoSurtidor.Estado && TramaRx.Length > 20 ) //DCF 10/09/2018
               {
                   CRC_RX_ = false;
...
"|" + CaraID + "|*8|Verificando conexion 2 " + EsInicializado);
        ...
        public bool Predeterminar()
        {
            try
            {
                ...
                if (EstructuraRedSurtidor[CaraEncuestada].PredeterminarImporte &&
                     EstructuraRedSurtidor[CaraEncuestada].ValorPredeterminado <= 999999)// DCF 01/09/2018
                    {
