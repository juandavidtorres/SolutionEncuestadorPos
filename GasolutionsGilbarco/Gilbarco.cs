        ...
        public Gilbarco(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                if (!PuertoCom.IsOpen)
                {
                    ...
                    PuertoCom.BaudRate = 5760;//5760;//oRIGINAL
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2015.12.29-0953-*");//Para manejar la cara 16 Fecha: 29-12-2015
                SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Gilbarco. Modificado 2018.03.8-1749-*");//DCF Archivos .txt 08/03/2018  
                            ...
                            for (int ContadorGrados = 0; ContadorGrados <= EstructuraRedSurtidor[CaraTmp].ListaGrados.Count - 1; ContadorGrados++)
                            {
                               ...
                               SWRegistro.Flush();// Borrar solo para Inspección
                                ...
                                EstructuraRedSurtidor[CaraTmp].ListaGrados[ContadorGrados].PrecioNivel1 =
                                   (Grados[EstructuraRedSurtidor[CaraTmp].ListaGrados[ContadorGrados].MangueraBD].PrecioNivel1) /
                                   EstructuraRedSurtidor[CaraTmp].MultiplicadorPrecioVenta; //DCF precio  2011.03.15-1705
