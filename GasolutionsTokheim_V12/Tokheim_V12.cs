    ...
    public class Tokheim : iProtocolo
    {
        ...
        public Tokheim(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto TCP/IP. Modificado 2016.03.10 1810");//Nueva version Medellin Tokheim V12 ----10-03-2016 - 1551 para valores superiores al millon 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2016.11.03 1648");//TCP/ Se cambia el VerifySizeFile()
               // SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.06.15 1700");//DCF 15/06/2017 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.09.25 1453 *");//DCF 25/09/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.09.27 155 *");//DCF 27/09/2017 tiempo de prueba 8000
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2018.01.19  2037*"); //DCF 19/01/2018 
                 SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2018.03.20 1511 *");//DCF 20/03/2018 Logueo Tramas
                SWRegistro.Flush();
                ...
                foreach (RedSurtidor oCara in EstructuraRedSurtidor.Values)
                {
                        ...
                        foreach (Grados oGrado in EstructuraRedSurtidor[oCara.Cara].ListaGrados)
                        {
                            ...
                            if (EstructuraRedSurtidor[oCara.Cara].EsVentaParcial)//DCF 25/09/2017
                            {
                                if (Convert.ToInt32(EstructuraRedSurtidor[oCara.Cara].GradoMangueraVentaParcial) >= 0)
                                {
                                    ...
                                    SWRegistro.WriteLine(DateTime.Now + "|" + oCara.Cara + "|Inicio *** |EsVentaParcial: " + oCara.EsVentaParcial + " - GradoMangueraVentaParcial: " + oCara.GradoMangueraVentaParcial + " - GradoAutorizado: " + EstructuraRedSurtidor[oCara.Cara].GradoAutorizado);
                                }
                            }


                            SWRegistro.WriteLine(DateTime.Now + "|" + oCara.Cara + "|Inicio|Grado: " + oGrado.NoGrado + " - Manguera: " + oGrado.MangueraBD +
                                " - IdProducto: a" + oGrado.IdProducto + " - Precio: " + oGrado.PrecioNivel1 + " - Venta Parcial: " + oCara.EsVentaParcial + " -GradoMangueraVentaParcial: " + oCara.GradoMangueraVentaParcial + " - Eco = " + Eco + " - delay_ + " + delay_+ " -LogueoTramas = " +LogueoTramas);//DCF 27/09/2017
                        }
        ...
        public Tokheim(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.06.15 1700");//DCF 15/06/2017 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.09.25 1453");//DCF 25/09/2017
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2017.09.27 1555");//DCF 27/09/2017 tiempo de prueba 8000 
                //SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2018.01.19 2037"); //DCF 19/01/2018
                  SWRegistro.WriteLine(DateTime.Now + "|0|Inicio|Protocolo Tokheim_Mixto V12 TCP/IP. Modificado 2018.03.20 1511");//DCF 20/03/2018 Logueo Tramas
                {
                ...
                switch (ComandoCaras)
                {
                    ...
                    case ComandoSurtidor.AutorizarDespacho://ok
                        ...
                        if (EstructuraRedSurtidor[CaraEncuestada].Gilbarco_Extended)
                        {
                            ...
                            if (EstructuraRedSurtidor[CaraEncuestada].PredeterminarImporte)
                            {
                                if (EstructuraRedSurtidor[CaraEncuestada].ValorPredeterminado <= 99999999) //DCF 18/08/2011 DCF precio Terpel 23/08/2011;;
                                {
                                    ...
                                    //Nueva version Medellin Tokheim V12 ----10-03-2016 - 1551 para valores superiores al millon 
                                    strValorImporte = Convert.ToString(Convert.ToInt32(EstructuraRedSurtidor[CaraEncuestada].ValorPredeterminado)).PadLeft(8, '0');
                                ...
                                //    //Borra
                                //    SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|*****Predeterminacion 1 VOlumen  " + strValorVolumen);
                                //    SWRegistro.Flush();
                            ...
                            else if (EstructuraRedSurtidor[CaraEncuestada].PredeterminarVolumen)
                            {
                                ...
                                //Nueva version Medellin Tokheim V12 ----10-03-2016 - 1551 para valores superiores al millon 
                                strValorVolumen = Convert.ToString(Convert.ToInt32(EstructuraRedSurtidor[CaraEncuestada].ValorPredeterminado * 1000)).PadLeft(8, '0');


                                //Borrar
                                SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|*****Predeterminacion 2 VOlumen  " + strValorVolumen);
                                SWRegistro.Flush();
                        ...
                        else
                        {
                            ...
                            if (EstructuraRedSurtidor[CaraEncuestada].PredeterminarImporte)
                            {
                                ...
                                else
                                {
                                   ...
                                   * EstructuraRedSurtidor[CaraEncuestada].MultiplicadorPrecioVenta) * EstructuraRedSurtidor[CaraEncuestada].FactorVolumen)).PadLeft(6, '0');
                                    ...
                                    //Borrar
                                    SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|*****Predeterminacion 3 VOlumen  " + strValorVolumen);
                                    SWRegistro.Flush();
                                }
                            ...
                            else if (EstructuraRedSurtidor[CaraEncuestada].PredeterminarVolumen)
                            {
                                ...
                                //Borrar
                                SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|*****Predeterminacion 4 VOlumen  " + strValorVolumen);
                                SWRegistro.Flush();
                    ...
                    case ComandoSurtidor.Inicializar://ok
                        ...
                        if (EstructuraRedSurtidor[CaraEncuestada].Gilbarco_Extended)
                        {
                            ...
                            SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada + "|Proceso| Precio Nivel 1 para Tokheim 5 Digitos - " + EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1); //DCF 25/09/2017
                            SWRegistro.Flush();
                            ...
                            strPrecio = Convert.ToString(Convert.ToInt16(EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1 * EstructuraRedSurtidor[CaraEncuestada].FactorPrecio)).PadLeft(6, '0'); //DCF 25/09/2017
                        ...
                        else
                        {
                            ...
                            SWRegistro.WriteLine(DateTime.Now + "|" + CaraEncuestada + "|Proceso| Precio Nivel 1 " + EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1);//DCF 25/09/2017
                            SWRegistro.Flush();
                            ...
                            strPrecio = Convert.ToString(Convert.ToInt16(EstructuraRedSurtidor[CaraEncuestada].ListaGrados[0].PrecioNivel1 *
                                        EstructuraRedSurtidor[CaraEncuestada].FactorPrecio)).PadLeft(4, '0');//DCF 25/09/2017
                    ...
                    case ComandoSurtidor.EstablecerPrecio_CX:
                        ...
                        else
                        {
                           ...
                           // TramaTx[0] = (byte)(0xD0 | (CaraEncuestada - 1));
                            TramaTx[0] = (byte)(0xC0 | (CaraEncuestada - 1)); //DCF 19/01/2018 PRUEBA NO EXISTIA
                            TramaTx[2] = 0XA3;
                        }
        ...
        private void EnviarComando()
        {
            try
            {
                ...
                if (LogueoTramas)//DCF 20/03/2018 Logueo Tramas
                {
                    ...
                    Thread.Sleep(TimeOut + delay_);//DCF 25/09/2017
        ...
        private void RecibirInformacion()
        {
            try
            {
                ...
                //if (Bytes >= BytesEsperados)//DCF 27/09/2017
                //{
