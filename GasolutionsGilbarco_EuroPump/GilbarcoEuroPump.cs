...
{
    public class GilbarcoEuroPump : iProtocolo
    {
        ...
        public GilbarcoEuroPump(bool EsTCPIP, string DireccionIP, string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            ...
            try
            {
                ...
                SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS - TCP_IP.  Modificado 31-05-2017 - 1744");//30/05/2017 entra en Error cuando se consulata el parcial de venta, se quita este comendo 
                SWRegistro.WriteLine("=====================================================================");
                SWRegistro.Flush();
        ...
        public GilbarcoEuroPump(string Puerto, Dictionary<byte, RedSurtidor> EstructuraCaras, bool Eco)
        {
            try
            {
                ...
                //  SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS.  Modificado 23-02-2016 - 1414");//para No cambiar en el configurador los surtidores que tiene 3 manguera pero solo despachan por 1 Para varias Mangueras 23-06-2015                       
                //SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS - TCP_IP.  Modificado 31-05-2017 - 1744");//30/05/2017 entra en Error cuando se consulata el parcial de venta, se quita este comendo              
                SWRegistro.WriteLine(DateTime.Now + " GILBARCOKRAUS - TCP_IP.  Modificado 08-03-2018 - 1648");//DCF Archivos .txt 08/03/2018 
        ...
        private void RecibirInformacion()
        {
            try
            {
                ...
                Thread.Sleep(300);//Tiempo de espera generar erro en lo glp 30/05/2017
            ...
            try
            {
                ...
                switch (EstructuraRedSurtidor[CaraEncuestada].Estado)
                {
                    ...
                    case (EstadoCara.Despacho):
                       ...
                       ////30/05/2017 entra en Error cuando se consulata el parcial de venta, se quita este comendo    
                       // //Pedir Parciales de Venta SE QUITA PARA SOLO PRUEBAS CAÑATE ojo DESCOMENTAR
        ...
        // public void Evento_VentaAutorizada(byte Cara, string Precio, string ValorProgramado, byte TipoProgramacion, string Placa, int MangueraProgramada, bool EsVentaGerenciada, string guid)
        {
            ...
            {
                string MensajeExcepcion = "Excepción en el Método oEvento_VentaAutorizada: " + Excepcion;
                SWRegistro.WriteLine(DateTime.Now + "|" + CaraID + "|Excepcion|" + MensajeExcepcion);
                SWRegistro.Flush();
            }
        }
        ...
        public void Evento_TurnoCerrado(string Surtidores, string PuertoTerminal)
        {
            ...
            {
                string MensajeExcepcion = "Excepción en el Método oEvento_TurnoCerrado: " + Excepcion;
                SWRegistro.WriteLine(DateTime.Now + "|Excepcion|" + MensajeExcepcion);
                SWRegistro.Flush();
            }
        }
        ...
        public void Evento_InactivarCaraCambioTarjeta(byte Cara, string Puerto)
        {
            ...
            {
                string MensajeExcepcion = "Excepción en el Evento oEvento_InactivarCaraCambioTarjeta: " + Excepcion;
        ...
        public void Evento_FinalizarCambioTarjeta(byte Cara)
        {
            ...
            {
                string MensajeExcepcion = "Excepción en el Evento oEvento_FinalizarCambioTarjeta: " + Excepcion;
                SWRegistro.WriteLine(DateTime.Now + "|Cara|" + Cara + "|Excepcion|" + MensajeExcepcion);
                SWRegistro.Flush();
            }
        }
